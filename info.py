...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Mr_Virus_Original') # without @ or https://t.me/ 
USERNAME = environ.get('USERNAME', "Dead_V2_Bot") # ADMIN USERNAME

# Database Channel 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '').split()]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002224811479'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002224811479'))
...
# MongoDB 
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://V2Premium:j9X2vMS3miNdTTnh@cluster0.ant6zrf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")

# Files index database url
FILES_DATABASE = environ.get('FILES_DATABASE', "mongodb+srv://V2Premium:j9X2vMS3miNdTTnh@cluster0.ant6zrf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Wamika')

# Other Channel's
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002184377685'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','0'))
request_channel = environ.get('REQUEST_CHANNEL', '-1001995831309') 
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002575608085')) 

# Added Link Here Not Id 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+BteK_SCyV8hhZjM1')
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+BteK_SCyV8hhZjM1')

# Verification
IS_VERIFY = is_enabled('IS_VERIFY', True)
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/How_To_Verify")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/How_To_Verify")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/How_To_Verify")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "aae55b0a94d4f309ef5aec38f713a926ea68bc29")
